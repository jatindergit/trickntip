...
Tags: hreview, aggregate rating, author reviews, editor reviews, product reviews, reviews, author, editor, rating, rich snippets, review website, schema, schema.org, google, seo, search engine optimization, microformat, microformats, snippets, snippet, google rich snippets, widget, search result, search engine, search, product reviews, rating stars, post, wordpress, plugins
...
Abusing search engines in not a good practice, especially if this can hurt others, some webmasters fake or fabricate reviews in a try to get more traffic to their sites. You can easily report them to Google. If you see any spam reviews fill this [form](http://support.google.com/webmasters/bin/request.py?hl=en&contact_type=rich_snippets_spam) to report it to Google.
...
7. Google Rich Snippets in search results.
